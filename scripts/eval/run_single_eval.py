...
Usage:
    python scripts/eval/run_single_eval.py                  # first task
    python scripts/eval/run_single_eval.py --task 3         # task index 3
    python scripts/eval/run_single_eval.py --task-id retail_task_40  # by task ID
"""
